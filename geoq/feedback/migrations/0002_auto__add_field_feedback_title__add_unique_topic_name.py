...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'feedback_feedback', 'title',
                      self.gf('django.db.models.fields.CharField')(default='GeoK Feedback', max_length=80),
                      keep_default=False)
    ...
    models = {
        u'feedback.feedback': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'default': "'GeoK Feedback'", 'max_length': '80'}),
