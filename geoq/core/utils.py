...
def send_assignment_email(user_or_group, job, request):
    subject = "GeoK Assignment for %s Project" % job.project.name
    ...
    message = "Hello GeoK User;\n  You have been assigned some workcells in the GeoK system. Please go to \n\n" + \
            "%s \n\n To see your currently tasked work \n\nRegards,\nThe GeoK Team" % (work_uri)
