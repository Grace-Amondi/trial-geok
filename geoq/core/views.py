    ...
    def get_context_data(self, **kwargs):
        ...
        for job in self.object.job.project.jobs:
            if not job.id == self.object.job.id:
                ...
                layer = dict(attribution="GeoK Job Workcells", description=description, id=int(10000+job.id),
                ...
                layer = dict(attribution="GeoK Job Features", description=description, id=int(20000+job.id),
